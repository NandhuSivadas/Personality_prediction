...
# 2. Load Model with Memory Mapping
print("DEBUG: Trying to load model from:", MODEL_PATH)
try:
    # mmap_mode='r' is the secret sauce. 
    # It reads the file from disk instead of RAM.
    # NOTE: This ONLY works if model.joblib is NOT compressed.
...
def show_result():
    ...
    try:
        # Correct feature order from your Colab notebook
        COLAB_FEATURE_ORDER = [
